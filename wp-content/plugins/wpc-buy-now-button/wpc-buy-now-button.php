...
! defined( 'WPCBN_VERSION' ) && define( 'WPCBN_VERSION', '1.2.0' );
		...
		if ( ! class_exists( 'WPCleverWpcbn' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWpcbn {
				...
				function enqueue_scripts() {
					wp_enqueue_style( 'wpcbn-frontend', WPCBN_URI . 'assets/css/frontend.css', array(), WPCBN_VERSION );
					wp_enqueue_script( 'wpcbn-frontend', WPCBN_URI . 'assets/js/frontend.js', array( 'jquery' ), WPCBN_VERSION, true );
				}

				function admin_enqueue_scripts() {
					wp_enqueue_script( 'wpcbn-backend', WPCBN_URI . 'assets/js/backend.js', array( 'jquery' ), WPCBN_VERSION, true );
				}
				...
				function admin_menu() {
					add_submenu_page( 'wpclever', esc_html__( 'WPC Buy Now Button', 'wpc-buy-now-button' ), esc_html__( 'Buy Now Button', 'wpc-buy-now-button' ), 'manage_options', 'wpclever-wpcbn', array(
						$this,
						'admin_menu_content'
					) );
				}
                    ...
                    <div class="wpclever_settings_page wrap">
                        ...
                        <div class="wpclever_settings_page_desc about-text">
                            <p>
                                ...
                                <a href="<?php echo esc_url( WPCBN_REVIEWS ); ?>"
                                   target="_blank"><?php esc_html_e( 'Reviews', 'wpc-buy-now-button' ); ?></a> | <a
                                        href="<?php echo esc_url( WPCBN_CHANGELOG ); ?>"
                        ...
                        <div class="wpclever_settings_page_nav">
                            <h2 class="nav-tab-wrapper">
                                <a href="<?php echo admin_url( 'admin.php?page=wpclever-wpcbn&tab=settings' ); ?>"
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="wpcbn_settings[button_text]"
                                                       value="<?php echo self::get_setting( 'button_text', '' ); ?>"
                                                       placeholder="<?php esc_html_e( 'Buy now', 'wpc-buy-now-button' ); ?>"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input name="wpcbn_settings[redirect_custom]" type="url"
                                                       class="regular-text wpcbn_redirect_custom"
                                                       value="<?php echo esc_url( self::get_setting( 'redirect_custom' ) ); ?>"/>
                                            </td>
                                        </tr>
                                        <tr class="submit">
                                            <th colspan="2">
												<?php settings_fields( 'wpcbn_settings' ); ?>
												<?php submit_button(); ?>
                                            </th>
                                        </tr>
                                    </table>
