...
function themefarmer_companion_newstore_ocdi_import_files() {
	return array(
		array(
			...
			'import_preview_image_url'     => esc_url(THEMEFARMER_COMPANION_URI . '/theme-files/demos/newstore/screenshot-fastshop-ecommerce.jpg'),
			'preview_url'                  => esc_url('https://demo.themefarmer.com/fastshop-ecommerce/'),
		),
		array(
			'import_file_name'             => 'Demo 1',
			'categories'                   => array('Customizer'),
